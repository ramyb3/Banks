function Bank(props)
{
    return(<>
        ...
        {props.bank.day_closed!='' ?
            <div className="close">סגור ב{props.bank.day_closed}'</div> : null
        }

        <div className="address type">סוג סניף: {props.bank.Branch_Type}</div>

        <a href={"https://www.google.co.il/maps/search/"+props.bank.City+' '+props.bank.Branch_Address} target="_blank" rel="noreferrer">
